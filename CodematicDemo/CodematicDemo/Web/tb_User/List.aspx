<%@ Page Title="tb_User" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.tb_User.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="WorkType" HeaderText="WorkType" SortExpression="WorkType" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="CreateTime" HeaderText="CreateTime" SortExpression="CreateTime" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ChangeTime" HeaderText="ChangeTime" SortExpression="ChangeTime" ItemStyle-HorizontalAlign="Center"  /> 
