...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.tb_KuCunRecords dal=new Maticsoft.DAL.tb_KuCunRecords();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.tb_KuCunRecords GetModelByCache(string HuoJiaHao,string CengHao,string LieHao)
		{
			
			string CacheKey = "tb_KuCunRecordsModel-" + HuoJiaHao+CengHao+LieHao;
			...
			return (Maticsoft.Model.tb_KuCunRecords)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.tb_KuCunRecords> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.tb_KuCunRecords> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.tb_KuCunRecords> modelList = new List<Maticsoft.Model.tb_KuCunRecords>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.tb_KuCunRecords model;
